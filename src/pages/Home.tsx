  ...
  return (
    <section className="relative py-16 bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 left-10 w-64 h-64 bg-[#34B8C3] opacity-5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-10 w-72 h-72 bg-[#233D60] opacity-5 rounded-full blur-3xl"></div>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* Trust Badge Header - More Subtle */}
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center mb-3">
            <Shield className="text-[#34B8C3] mr-2" size={20} strokeWidth={2} />
            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Vertrouwd door duizenden</span>
          </div>
        ...
        {/* Trust Indicators Row - Matching Diensten Page Color */}
        <div className="bg-gradient-to-r from-[#34B8C3] to-[#233D60] rounded-xl shadow-lg p-6 md:p-8">
          <div className="grid md:grid-cols-3 gap-6 items-center text-white">
            <div className="flex items-center space-x-3">
              <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center bg-white/20 backdrop-blur-sm">
                <Star className="text-white" size={20} strokeWidth={2} fill="white" />
              </div>
              <div>
                <h4 className="font-bold mb-0.5 text-sm">Topkwaliteit</h4>
                <p className="text-xs opacity-90">Hoogwaardige materialen en technieken</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-bold mb-0.5 text-sm">Langdurige Garantie</h4>
                <p className="text-xs opacity-90">Vol vertrouwen in onze werkzaamheden</p>
              </div>
            </div>

            <div className="flex items-center space-x-3">
              <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center bg-white/20 backdrop-blur-sm">
                <CheckCircle2 className="text-white" size={20} strokeWidth={2} />
              </div>
              <div>
                <h4 className="font-bold mb-0.5 text-sm">Gecertificeerd</h4>
                <p className="text-xs opacity-90">Professioneel en betrouwbaar</p>
              </div>
            </div>
          </div>
        </div>
