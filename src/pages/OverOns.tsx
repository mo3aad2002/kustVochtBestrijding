import { Heart, Award, Users, Shield, Wrench, BookOpen, TrendingUp, MapPin, Home, CheckCircle } from 'lucide-react';
...
import valuesImage from '../assets/ChatGPT_Image_Feb_24,_2026,_01_11_26_PM.png';
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-600 text-lg mb-12 max-w-3xl mx-auto">
          Bij Kust Vochtbestrijding draait alles om vertrouwen, vakmanschap en resultaat.
